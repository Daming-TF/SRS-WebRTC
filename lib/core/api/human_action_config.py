...
config.SDKParamType.HYAI_MOBILE_SDK_PARAM_FACE_DETECT_INITNUM = 8                   # 设置连续有多少帧人脸的时候才返回结果，默认是2帧. 设置范围是[0, 3], 值越小从无到有返回人脸的速度越快
...
config.detectConfig = config.HY_MOBILE_FACE_DETECT | config.HY_MOBILE_DETECT_EXTRA_FACE_POINTS | config.HY_MOBILE_DETECT_SRC_FACE_POINTS | config.HY_MOBILE_DETECT_FACE_GAZE | config.HY_MOBILE_BODY_KEYPOINTS
