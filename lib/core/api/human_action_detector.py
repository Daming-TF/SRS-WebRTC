...
class HumanActionDetector:
    ...
    def run(self, img, pixFormat, imgRotate, detectConfig):
        ...
        runDetector.argtypes = [c_void_p, POINTER(c_ubyte), c_int, c_int, c_int, c_int, c_int, c_int64, POINTER(HYHumanActions)]
        runDetector.restype = c_int

        detResult = HYHumanActions()
        errCode = runDetector(self.net, data, pixFormat, imgW, imgH, widthStep, imgRotate, detectConfig, detResult)
    ...
    def det_lmk_only(self, img, pixFormat, imgRotate, bbox, detectConfig):
        ...
        runLmkDetector.argtypes = [c_void_p, POINTER(c_ubyte), c_int, c_int, c_int, c_int, c_int, c_int64, c_int, c_int, c_int, c_int, POINTER(HYHumanActions)]
        runLmkDetector.restype = c_int

        detResult = HYHumanActions()
        errCode = runLmkDetector(self.net, data, pixFormat, imgW, imgH, widthStep, imgRotate, detectConfig, bbox_left, bbox_top, bbox_width, bbox_height, detResult)
