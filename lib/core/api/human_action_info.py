...
from ctypes import c_float, c_int, Structure, POINTER, c_void_p, c_ubyte, c_int64, c_ulonglong
...
class HYHumanActions(Structure):
    _fields_ = [("d_faces", POINTER(HYFaceInfo)),
                ("faces_count", c_int),
