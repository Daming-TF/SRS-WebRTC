...
def recognize_gesture(landmarks):
    ...
    # Gesture
    if hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 1 and \
            hand.little_state == 1:
        hand.gesture = "Five"
    elif hand.thumb_state == 0 and hand.index_state == 0 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 0 and hand.fist_dist == 1:
        hand.gesture = "Fist"
    elif hand.thumb_state == 1 and hand.index_state == 0 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 0 and hand.fist_dist == -1:
        hand.gesture = "Thumb"
    elif hand.thumb_state == 0 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 0 and \
            hand.little_state == 0:
        hand.gesture = "Two"
    elif hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and hand.little_state == 0 and \
            hand.rock_dist == 1:
        hand.gesture = "One"
    elif hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 0 and hand.heart_dist == -1:
        hand.gesture = "Gun"
    elif hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 0 and hand.heart_dist == 1:
        hand.gesture = "Heart"
    elif hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 1 and hand.rock_dist == -1:
        hand.gesture = "Ivu"
    elif hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and hand.little_state == 1 and \
            hand.rock_dist == 1:
        hand.gesture = "Rock"
    elif hand.thumb_state == 1 and hand.index_state == 0 and hand.middle_state == 0 and hand.ring_state == 0 and \
            hand.little_state == 1:
        hand.gesture = "Six"
    elif hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 0 and \
            hand.little_state == 0:
        hand.gesture = "Three"
    elif hand.thumb_state == 0 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 1 and \
            hand.little_state == 0:
        hand.gesture = "Three"
    elif hand.thumb_state == 0 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 1 and \
            hand.little_state == 1:
        hand.gesture = "Four"
    elif hand.index_state == 0 and hand.middle_state == 1 and hand.ring_state == 1 and hand.little_state == 1 and \
            hand.ok_dist == 1:
        hand.gesture = "OK"
    else:
        hand.gesture = None
